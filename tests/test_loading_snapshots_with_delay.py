...
class TestLoadingSnapshotsWithDelay:
    ...
    def slow_path_operations(self):
        ...
        with patch.object(Path, "iterdir", delayed_iterdir), patch.object(Path, "is_dir", delayed_is_dir), patch.object(Path, "stat", delayed_stat):
            yield
    ...
    def test_navigation_loading_visible_enter(self, snap_compare, slow_listdir):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            assert snap_compare(app, run_before=navigate_with_enter, terminal_size=(80, 24))
    ...
    def test_navigation_loading_visible_parent(self, snap_compare, slow_listdir):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            assert snap_compare(app, run_before=go_to_parent, terminal_size=(80, 24))
    ...
    def test_expansion_loading_placeholder_visible(self, snap_compare, slow_path_operations):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            assert snap_compare(app, run_before=expand_with_loading, terminal_size=(80, 24))
    ...
    def test_multiple_loading_indicators(self, snap_compare, slow_path_operations):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            assert snap_compare(app, run_before=expand_multiple_slow, terminal_size=(80, 24))
    ...
    def test_loading_indicator_blinking_style(self, snap_compare, slow_listdir):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            assert snap_compare(app, run_before=trigger_styled_loading, terminal_size=(80, 24))
...
class TestLoadingSnapshotsAllButtons:
    ...
    def test_back_button_loading(self, snap_compare, slow_filesystem):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            assert snap_compare(app, run_before=use_back_button, terminal_size=(80, 24))
    ...
    def test_forward_button_loading(self, snap_compare, slow_filesystem):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            assert snap_compare(app, run_before=use_forward_button, terminal_size=(80, 24))
    ...
    def test_parent_button_loading(self, snap_compare, slow_filesystem):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            assert snap_compare(app, run_before=use_parent_button, terminal_size=(80, 24))
    ...
    def test_home_button_loading(self, snap_compare, slow_filesystem):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            assert snap_compare(app, run_before=use_home_button, terminal_size=(80, 24))
    ...
    def test_root_button_loading(self, snap_compare, slow_filesystem):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            assert snap_compare(app, run_before=use_root_button, terminal_size=(80, 24))
    ...
    def test_all_navigation_methods(self, snap_compare, slow_filesystem):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            assert snap_compare(app, run_before=multiple_navigations, terminal_size=(80, 24))
