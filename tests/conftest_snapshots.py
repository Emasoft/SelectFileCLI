...
def pytest_configure(config):
    ...
    config.addinivalue_line("markers", "snapshot: mark test as a visual snapshot test")
    config.addinivalue_line("markers", "loading: mark test as testing loading indicators")
