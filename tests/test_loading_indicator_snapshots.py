...
class TestLoadingIndicatorSnapshots:
    ...
    def test_navigation_loading_parent_button(self, snap_compare):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            assert snap_compare(
                app,
                run_before=click_parent_button,
                terminal_size=(80, 24)
            )
    ...
    def test_navigation_loading_forward_button(self, snap_compare):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            assert snap_compare(
                app,
                run_before=navigate_back_then_forward,
                terminal_size=(80, 24)
            )
    ...
    def test_navigation_loading_keyboard_shortcuts(self, snap_compare):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            assert snap_compare(
                app,
                run_before=use_keyboard_shortcut,
                terminal_size=(80, 24)
            )
    ...
    def test_loading_with_sorting_dialog(self, snap_compare):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            assert snap_compare(
                app,
                run_before=change_sort_and_navigate,
                terminal_size=(80, 24)
            )
    ...
    def test_loading_indicator_styles(self, snap_compare):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            assert snap_compare(
                app,
                run_before=trigger_both_loading_types,
                terminal_size=(80, 24)
            )
